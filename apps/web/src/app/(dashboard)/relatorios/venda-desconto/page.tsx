  ...
  async function handleExport() {
    ...
    try {
      const columns: ExcelColumn[] = [
        ...
        { header: 'Custo Produção', key: 'custoProducao', width: 14, format: 'currency' },
        { header: 'PDV Original', key: 'pdvOriginal', width: 14, format: 'currency' },
        { header: 'PDV Atual', key: 'pdvAtual', width: 14, format: 'currency' },
        { header: 'Markup', key: 'markup', width: 10, format: 'number' },
        { header: '% Desconto', key: 'descontoPct', width: 12, format: 'percent' },
        { header: 'PDV Venda', key: 'pdvVenda', width: 14, format: 'currency' },
        { header: 'Vendas', key: 'vendas', width: 10, format: 'number' },
        { header: 'Estoque Fim', key: 'estoqueFim', width: 12, format: 'number' },
        { header: '% Giro', key: 'giro', width: 10, format: 'percent' },
        { header: 'TT Estq Original', key: 'ttEstqVdaOriginal', width: 16, format: 'currency' },
        { header: 'TT Estq Atual', key: 'ttEstqVdaAtual', width: 16, format: 'currency' },
        { header: '% Desc Estq', key: 'pctDesconto', width: 12, format: 'percent' },
        { header: 'TT Venda', key: 'ttVdaVda', width: 14, format: 'currency' },
        { header: 'TT Desc Venda', key: 'ttDescontoVenda', width: 14, format: 'currency' },
      ];
